...
export default function ArrecadacoesPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold">ArrecadaÃ§Ãµes</h1>
        <p className="text-sm text-slate-500">
          Cada arrecadaÃ§Ã£o pode servir um ou vÃ¡rios apartamentos. Abre uma para rever a
            ...
            >
              <div className="flex items-start justify-between">
                ...
                <span className="text-[10px] uppercase tracking-wide text-slate-400 border border-slate-200 rounded px-1.5 py-0.5">
                  {a.tipo === "armario" ? "ArmÃ¡rio" : "ArrecadaÃ§Ã£o"}
                </span>
              </div>
      ...
      <div className="bg-white rounded-lg border border-slate-200 p-4 max-w-md">
        <h2 className="font-medium text-sm mb-3">Adicionar nova arrecadaÃ§Ã£o</h2>
        <div className="flex flex-col gap-2">
          <input
            type="text"
            placeholder="Nome (ex: ArrecadaÃ§Ã£o Rato â Zona Nova)"
            value={nomeNovo}
          ...
          <select
            ...
            className="border border-slate-200 rounded-md px-2 py-1.5 text-sm"
          >
            <option value="arrecadacao">ArrecadaÃ§Ã£o</option>
