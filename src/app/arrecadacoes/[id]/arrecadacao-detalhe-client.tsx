...
export default function ArrecadacaoDetalheClient({ id: idInicial }: { id: string }) {
  ...
  // Em produÃ§Ã£o estÃ¡tica, um id que nÃ£o foi prÃ©-gerado Ã© servido atravÃ©s de um
  // redirect de fallback (ver netlify.toml) usando o HTML de outra pÃ¡gina; por
  // isso o id real Ã© sempre derivado do URL do browser, nÃ£o da prop de build.
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <div className="bg-white rounded-lg border border-slate-200">
          <div className="px-4 py-3 border-b border-slate-100">
            <h2 className="font-medium">Checklist semanal de referÃªncia</h2>
          </div>
          ...
          <div className="p-4 border-t border-slate-100 flex gap-2">
            ...
            >
              <option value="">Adicionar produto Ã  checklistâ¦</option>
              {produtos
                    ...
                    <li key={f.id} className="px-4 py-2.5 text-sm flex items-center justify-between">
                      <div>
                        <p className={f.resolvido ? "line-through text-slate-400" : "font-medium"}>
                          {produto?.nome} â faltam {f.quantidadeFalta}
                        </p>
          ...
          <div className="bg-white rounded-lg border border-slate-200">
            ...
            {Object.keys(gastoPorMes).length === 0 ? (
              <p className="p-4 text-sm text-slate-500">
                Ainda sem compras concluÃ­das atribuÃ­das a esta arrecadaÃ§Ã£o.
              </p>
            ) : (
              <ul className="divide-y divide-slate-100">
            ...
            <p className="px-4 pb-3 text-[11px] text-slate-400">
              Calculado a partir do preÃ§o registado em cada compra concluÃ­da da lista quinzenal
              destinada a esta arrecadaÃ§Ã£o.
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-slate-200 p-4">
            ...
            <div className="flex gap-2">
              <select
                ...
                className="flex-1 border border-slate-200 rounded-md px-2 py-1.5 text-sm"
              >
                <option value="">Associar apartamentoâ¦</option>
